(function (factory) {
    ...
    const syntaxConfig = {
        markup: {
            snippets: parseSnippets(window.markupSnippets),
        },
        xhtml: {
            options: {
    ...
    function resolveConfig(config = {}, globals = {}) {
        ...
        return Object.assign(Object.assign(Object.assign({}, defaultConfig$1), config), {
            type,
            syntax,
        ...
        scan$1(code, (type, start, end, delimiter) => {
            ...
            if (type === "selector" /* Selector */) {
                ...
                result = {
                    ...
                    ranges: [
                        [pendingProperty[0], pendingProperty[1]]
                    ]
                };
                return false;
            }
    ...
    class AbbreviationTrackingController {
        ...
        typingAbbreviation(editor, pos) {
            ...
            if (start >= 0) {
                ...
                if (config) {
                    ...
                    const tracker = this.startTracking(editor, start, end, {
                        offset,
                        config
                    });
        ...
        startTracking(editor, start, pos, params) {
            ...
            const tracker = this.createTracker(editor, [start, pos], Object.assign({
                config
            }, params));
            if (tracker) {
        ...
        createTracker(editor, range, params) {
            ...
            try {
                ...
                return Object.assign(Object.assign({}, base), {
                    ...
                    simple,
                    preview: expandAbbreviation(parsedAbbr, previewConfig)
                });
            } catch (error) {
                return Object.assign(Object.assign({}, base), {
                    type: "error" /* Error */,
        ...
        getActivationContext(editor, pos) {
            ...
            if (editor.isHTML(syntax)) {
                const ctx = getHTMLContext(content, pos, {
                    xml: editor.isXML(syntax)
                });
                if (ctx.css) {
         ...
         */
        isTypingBeforeSelector(editor, pos, {
            current
        }) {
    ...
    function extract$1(code, pos, type = 'markup', options) {
        return extractAbbreviation(code, pos, Object.assign({
    ...
    function getTagContext(editor, pos, xml) {
        ...
        const matchedTag = match(content, pos, {
            xml
        });
        if (matchedTag) {
            const {
    ...
    function extractTracker(editor, pos, forceValid) {
        return proxy.run(editor, () => {
            ...
            const abbr = extract$1(proxy.substr(), pos, getSyntaxType(config === null || config === void 0 ? void 0 : config.syntax), {
                prefix
            });
            if (abbr) {
    ...
    function enterAbbreviationMode(editor) {
        ...
        tracker = startTracking(editor, from, to, {
            forced: true
        });
        if (from !== to) {
    ...
    function betweenTags(editor, anchor, head) {
        if (equalCursorPos(anchor, head)) {
            ...
            if (mode.name === 'xml') {
                ...
                const right = editor.getTokenAt(Object.assign({}, anchor, {
                    ch: anchor.ch + 1
                }));
        ...
        if (close) {
            ...
            if (!rangeEmpty(innerRange)) {
                ...
                if (start.line !== end.line) {
                    ...
                    while (line <= end.line) {
                        const lineStart = editor.indexFromPos({
                            line,
                            ch: 0
                        });
    ...
    function registerEmmetExtension(CM) {
        ...
        CM.defineExtension('parseAbbreviation', function (abbr, type) {
            if (type === 'stylesheet') {
                ...
                return abbreviation(tokenize(abbr), {
                    jsx: type === 'jsx'
                });
            }
        });
